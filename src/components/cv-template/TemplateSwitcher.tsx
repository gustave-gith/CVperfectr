...
export function TemplateSwitcher({ 
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center gap-4 bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm print:hidden">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                selected === opt.id
                  ...
                  : 'bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300 border border-gray-300 dark:border-gray-700 hover:border-indigo-400 dark:hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400'
              }`}
            >
              <span
      ...
      <label className="flex items-center gap-2 cursor-pointer group ml-auto sm:ml-0">
        <input
          ...
          className="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-700 rounded focus:ring-indigo-500 cursor-pointer"
        />
